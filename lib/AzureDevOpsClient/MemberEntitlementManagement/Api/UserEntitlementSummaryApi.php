...
class UserEntitlementSummaryApi
{
    ...
    /**
     * Operation userEntitlementSummaryGet
     *
    ...
    {
        list($response) = $this->userEntitlementSummaryGetWithHttpInfo($organization, $apiVersion, $select);
        return $response;
    }

    /**
     * Operation userEntitlementSummaryGetWithHttpInfo
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     * @param  string $select Comma (\&quot;,\&quot;) separated list of properties to select. Supported property names are {AccessLevels, Licenses, Projects, Groups}. (optional)
    ...
    /**
     * Operation userEntitlementSummaryGetAsync
     *
     * 
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    public function userEntitlementSummaryGetAsync($organization, $apiVersion, $select = null)
    {
        return $this->userEntitlementSummaryGetAsyncWithHttpInfo($organization, $apiVersion, $select)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation userEntitlementSummaryGetAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
    ...
    /**
     * Create request for operation 'userEntitlementSummaryGet'
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     * @param  string $select Comma (\&quot;,\&quot;) separated list of properties to select. Supported property names are {AccessLevels, Licenses, Projects, Groups}. (optional)
     ...
     */
    protected function userEntitlementSummaryGetRequest($organization, $apiVersion, $select = null)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling userEntitlementSummaryGet'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling userEntitlementSummaryGet'
            );
        }

        $resourcePath = '/{organization}/_apis/userentitlementsummary';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
