...
class SubscribersApi
{
    ...
    {
        list($response) = $this->subscribersGetWithHttpInfo($subscriberId, $organization, $apiVersion);
        return $response;
    }

    /**
     * Operation subscribersGetWithHttpInfo
     *
     * @param  string $subscriberId ID of the user or group. (required)
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     ...
     */
    public function subscribersGetAsync($subscriberId, $organization, $apiVersion)
    {
        return $this->subscribersGetAsyncWithHttpInfo($subscriberId, $organization, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation subscribersGetAsyncWithHttpInfo
     *
     *
     *
     * @param  string $subscriberId ID of the user or group. (required)
    ...
    /**
     * Create request for operation 'subscribersGet'
     *
     * @param  string $subscriberId ID of the user or group. (required)
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     ...
     */
    protected function subscribersGetRequest($subscriberId, $organization, $apiVersion)
    {
        // verify the required parameter 'subscriberId' is set
        if ($subscriberId === null || (is_array($subscriberId) && count($subscriberId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $subscriberId when calling subscribersGet'
            );
        }
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling subscribersGet'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling subscribersGet'
            );
        }

        $resourcePath = '/{organization}/_apis/notification/subscribers/{subscriberId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($subscriberId !== null) {
            $resourcePath = str_replace(
                '{' . 'subscriberId' . '}',
                ObjectSerializer::toPathValue($subscriberId),
                $resourcePath
            );
        }
        // path params
    ...
    {
        list($response) = $this->subscribersUpdateWithHttpInfo($body, $subscriberId, $organization, $apiVersion);
        return $response;
    }
    ...
    /**
     * Operation subscribersUpdateAsync
     *
     *
     *
     * @param  \FrankHouweling\AzureDevOpsClient\Notification\Model\NotificationSubscriberUpdateParameters $body  (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function subscribersUpdateAsync($body, $subscriberId, $organization, $apiVersion)
    {
        return $this->subscribersUpdateAsyncWithHttpInfo($body, $subscriberId, $organization, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation subscribersUpdateAsyncWithHttpInfo
     *
     *
     *
     * @param  \FrankHouweling\AzureDevOpsClient\Notification\Model\NotificationSubscriberUpdateParameters $body  (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function subscribersUpdateRequest($body, $subscriberId, $organization, $apiVersion)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling subscribersUpdate'
            );
        }
        // verify the required parameter 'subscriberId' is set
        if ($subscriberId === null || (is_array($subscriberId) && count($subscriberId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $subscriberId when calling subscribersUpdate'
            );
        }
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling subscribersUpdate'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling subscribersUpdate'
            );
        }
