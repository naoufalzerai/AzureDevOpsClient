...
class PagesBatchApi
{
    ...
    {
        list($response) = $this->pagesBatchGetWithHttpInfo($organization, $body, $project, $wikiIdentifier, $apiVersion, $versionDescriptorVersion, $versionDescriptorVersionOptions, $versionDescriptorVersionType);
        return $response;
    }
     ...
     */
    public function pagesBatchGetAsync($organization, $body, $project, $wikiIdentifier, $apiVersion, $versionDescriptorVersion = null, $versionDescriptorVersionOptions = null, $versionDescriptorVersionType = null)
    {
        return $this->pagesBatchGetAsyncWithHttpInfo($organization, $body, $project, $wikiIdentifier, $apiVersion, $versionDescriptorVersion, $versionDescriptorVersionOptions, $versionDescriptorVersionType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation pagesBatchGetAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    protected function pagesBatchGetRequest($organization, $body, $project, $wikiIdentifier, $apiVersion, $versionDescriptorVersion = null, $versionDescriptorVersionOptions = null, $versionDescriptorVersionType = null)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling pagesBatchGet'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling pagesBatchGet'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling pagesBatchGet'
            );
        }
        // verify the required parameter 'wikiIdentifier' is set
        if ($wikiIdentifier === null || (is_array($wikiIdentifier) && count($wikiIdentifier) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wikiIdentifier when calling pagesBatchGet'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling pagesBatchGet'
            );
        }

        $resourcePath = '/{organization}/{project}/_apis/wiki/wikis/{wikiIdentifier}/pagesbatch';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
