...
class AttachmentsApi
{
     ...
     * @param  string $name Wiki attachment name. (required)
    ...
    {
        list($response) = $this->attachmentsCreateWithHttpInfo($organization, $body, $project, $wikiIdentifier, $name, $apiVersion, $versionDescriptorVersion, $versionDescriptorVersionOptions, $versionDescriptorVersionType);
        return $response;
    }
     ...
     */
    public function attachmentsCreateAsync($organization, $body, $project, $wikiIdentifier, $name, $apiVersion, $versionDescriptorVersion = null, $versionDescriptorVersionOptions = null, $versionDescriptorVersionType = null)
    {
        return $this->attachmentsCreateAsyncWithHttpInfo($organization, $body, $project, $wikiIdentifier, $name, $apiVersion, $versionDescriptorVersion, $versionDescriptorVersionOptions, $versionDescriptorVersionType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function attachmentsCreateRequest($organization, $body, $project, $wikiIdentifier, $name, $apiVersion, $versionDescriptorVersion = null, $versionDescriptorVersionOptions = null, $versionDescriptorVersionType = null)
    {
        ...
        if ($wikiIdentifier === null || (is_array($wikiIdentifier) && count($wikiIdentifier) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wikiIdentifier when calling attachmentsCreate'
            );
        }
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $name when calling attachmentsCreate'
            );
        }
        ...
        $resourcePath = '/{organization}/{project}/_apis/wiki/wikis/{wikiIdentifier}/attachments';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
