...
class ActionsApi
{
    ...
    {
        list($response) = $this->actionsListWithHttpInfo($organization, $apiVersion, $areaName);
        return $response;
    }

    /**
     * Operation actionsListWithHttpInfo
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     * @param  string $areaName Optional. Get actions scoped to area (optional)
     ...
     */
    public function actionsListAsync($organization, $apiVersion, $areaName = null)
    {
        return $this->actionsListAsyncWithHttpInfo($organization, $apiVersion, $areaName)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation actionsListAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
    ...
    /**
     * Create request for operation 'actionsList'
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     * @param  string $areaName Optional. Get actions scoped to area (optional)
     ...
     */
    protected function actionsListRequest($organization, $apiVersion, $areaName = null)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling actionsList'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling actionsList'
            );
        }

        $resourcePath = '/{organization}/_apis/audit/actions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($areaName !== null) {
            $queryParams['areaName'] = ObjectSerializer::toQueryValue($areaName);
        }
        // query params
        if ($apiVersion !== null) {
