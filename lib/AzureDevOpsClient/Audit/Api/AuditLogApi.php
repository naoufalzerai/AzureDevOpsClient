...
class AuditLogApi
{
     ...
     * @param  int $batchSize Max number of results to return. Optional (optional)
    ...
    {
        list($response) = $this->auditLogQueryWithHttpInfo($organization, $apiVersion, $startTime, $endTime, $batchSize, $continuationToken, $skipAggregation);
        return $response;
    }

    /**
     * Operation auditLogQueryWithHttpInfo
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     * @param  \DateTime $startTime Start time of download window. Optional (optional)
     ...
     */
    public function auditLogQueryAsync($organization, $apiVersion, $startTime = null, $endTime = null, $batchSize = null, $continuationToken = null, $skipAggregation = null)
    {
        return $this->auditLogQueryAsyncWithHttpInfo($organization, $apiVersion, $startTime, $endTime, $batchSize, $continuationToken, $skipAggregation)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation auditLogQueryAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
    ...
    /**
     * Create request for operation 'auditLogQuery'
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     * @param  \DateTime $startTime Start time of download window. Optional (optional)
     ...
     */
    protected function auditLogQueryRequest($organization, $apiVersion, $startTime = null, $endTime = null, $batchSize = null, $continuationToken = null, $skipAggregation = null)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling auditLogQuery'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling auditLogQuery'
            );
        }

        $resourcePath = '/{organization}/_apis/audit/auditlog';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($skipAggregation !== null) {
            $queryParams['skipAggregation'] = ObjectSerializer::toQueryValue($skipAggregation);
        }
        // query params
        if ($apiVersion !== null) {
