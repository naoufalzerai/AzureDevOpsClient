...
class ArtifactsApi
{
    ...
    {
        list($response) = $this->artifactsCreateWithHttpInfo($organization, $body, $project, $buildId, $apiVersion);
        return $response;
    }
     ...
     */
    public function artifactsCreateAsync($organization, $body, $project, $buildId, $apiVersion)
    {
        return $this->artifactsCreateAsyncWithHttpInfo($organization, $body, $project, $buildId, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function artifactsCreateRequest($organization, $body, $project, $buildId, $apiVersion)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling artifactsCreate'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling artifactsCreate'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling artifactsCreate'
            );
        }
        // verify the required parameter 'buildId' is set
        if ($buildId === null || (is_array($buildId) && count($buildId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $buildId when calling artifactsCreate'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling artifactsCreate'
            );
        }

        $resourcePath = '/{organization}/{project}/_apis/build/builds/{buildId}/artifacts';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->artifactsListWithHttpInfo($organization, $project, $buildId, $apiVersion);
        return $response;
    }

    /**
     * Operation artifactsListWithHttpInfo
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  int $buildId The ID of the build. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function artifactsListAsync($organization, $project, $buildId, $apiVersion)
    {
        return $this->artifactsListAsyncWithHttpInfo($organization, $project, $buildId, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation artifactsListAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
    ...
    /**
     * Create request for operation 'artifactsList'
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  int $buildId The ID of the build. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function artifactsListRequest($organization, $project, $buildId, $apiVersion)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling artifactsList'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling artifactsList'
            );
        }
        // verify the required parameter 'buildId' is set
        if ($buildId === null || (is_array($buildId) && count($buildId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $buildId when calling artifactsList'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling artifactsList'
            );
        }
