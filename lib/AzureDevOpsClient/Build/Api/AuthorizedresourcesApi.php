...
class AuthorizedresourcesApi
{
    ...
    {
        list($response) = $this->authorizedresourcesAuthorizeProjectResourcesWithHttpInfo($organization, $body, $project, $apiVersion);
        return $response;
    }
    ...
    /**
     * Operation authorizedresourcesAuthorizeProjectResourcesAsync
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    public function authorizedresourcesAuthorizeProjectResourcesAsync($organization, $body, $project, $apiVersion)
    {
        return $this->authorizedresourcesAuthorizeProjectResourcesAsyncWithHttpInfo($organization, $body, $project, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation authorizedresourcesAuthorizeProjectResourcesAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    protected function authorizedresourcesAuthorizeProjectResourcesRequest($organization, $body, $project, $apiVersion)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling authorizedresourcesAuthorizeProjectResources'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling authorizedresourcesAuthorizeProjectResources'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling authorizedresourcesAuthorizeProjectResources'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling authorizedresourcesAuthorizeProjectResources'
            );
        }

        $resourcePath = '/{organization}/{project}/_apis/build/authorizedresources';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation authorizedresourcesList
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
    ...
    {
        list($response) = $this->authorizedresourcesListWithHttpInfo($organization, $project, $apiVersion, $type, $id);
        return $response;
    }

    /**
     * Operation authorizedresourcesListWithHttpInfo
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
    ...
    /**
     * Operation authorizedresourcesListAsync
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function authorizedresourcesListAsync($organization, $project, $apiVersion, $type = null, $id = null)
    {
        return $this->authorizedresourcesListAsyncWithHttpInfo($organization, $project, $apiVersion, $type, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation authorizedresourcesListAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
    ...
    /**
     * Create request for operation 'authorizedresourcesList'
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function authorizedresourcesListRequest($organization, $project, $apiVersion, $type = null, $id = null)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling authorizedresourcesList'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling authorizedresourcesList'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling authorizedresourcesList'
            );
        }
