...
class PackageSearchResultsApi
{
    ...
    {
        list($response) = $this->packageSearchResultsFetchPackageSearchResultsWithHttpInfo($organization, $body, $apiVersion);
        return $response;
    }
    ...
    /**
     * Operation packageSearchResultsFetchPackageSearchResultsAsync
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    public function packageSearchResultsFetchPackageSearchResultsAsync($organization, $body, $apiVersion)
    {
        return $this->packageSearchResultsFetchPackageSearchResultsAsyncWithHttpInfo($organization, $body, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation packageSearchResultsFetchPackageSearchResultsAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    protected function packageSearchResultsFetchPackageSearchResultsRequest($organization, $body, $apiVersion)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling packageSearchResultsFetchPackageSearchResults'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling packageSearchResultsFetchPackageSearchResults'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling packageSearchResultsFetchPackageSearchResults'
            );
        }

        $resourcePath = '/{organization}/_apis/search/packagesearchresults';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
