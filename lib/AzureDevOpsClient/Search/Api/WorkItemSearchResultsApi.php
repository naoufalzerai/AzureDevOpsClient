...
class WorkItemSearchResultsApi
{
    ...
    {
        list($response) = $this->workItemSearchResultsFetchWorkItemSearchResultsWithHttpInfo($organization, $body, $project, $apiVersion);
        return $response;
    }
    ...
    /**
     * Operation workItemSearchResultsFetchWorkItemSearchResultsAsync
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    public function workItemSearchResultsFetchWorkItemSearchResultsAsync($organization, $body, $project, $apiVersion)
    {
        return $this->workItemSearchResultsFetchWorkItemSearchResultsAsyncWithHttpInfo($organization, $body, $project, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation workItemSearchResultsFetchWorkItemSearchResultsAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    protected function workItemSearchResultsFetchWorkItemSearchResultsRequest($organization, $body, $project, $apiVersion)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling workItemSearchResultsFetchWorkItemSearchResults'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling workItemSearchResultsFetchWorkItemSearchResults'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling workItemSearchResultsFetchWorkItemSearchResults'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling workItemSearchResultsFetchWorkItemSearchResults'
            );
        }

        $resourcePath = '/{organization}/{project}/_apis/search/workitemsearchresults';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
