...
class CodeSearchResultsApi
{
    ...
    {
        list($response) = $this->codeSearchResultsFetchCodeSearchResultsWithHttpInfo($organization, $body, $project, $apiVersion);
        return $response;
    }
    ...
    /**
     * Operation codeSearchResultsFetchCodeSearchResultsAsync
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    public function codeSearchResultsFetchCodeSearchResultsAsync($organization, $body, $project, $apiVersion)
    {
        return $this->codeSearchResultsFetchCodeSearchResultsAsyncWithHttpInfo($organization, $body, $project, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation codeSearchResultsFetchCodeSearchResultsAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    protected function codeSearchResultsFetchCodeSearchResultsRequest($organization, $body, $project, $apiVersion)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling codeSearchResultsFetchCodeSearchResults'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling codeSearchResultsFetchCodeSearchResults'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling codeSearchResultsFetchCodeSearchResults'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling codeSearchResultsFetchCodeSearchResults'
            );
        }

        $resourcePath = '/{organization}/{project}/_apis/search/codesearchresults';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
