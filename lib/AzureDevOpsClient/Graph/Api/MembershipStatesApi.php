...
class MembershipStatesApi
{
    ...
    {
        list($response) = $this->membershipStatesGetWithHttpInfo($organization, $subjectDescriptor, $apiVersion);
        return $response;
    }

    /**
     * Operation membershipStatesGetWithHttpInfo
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $subjectDescriptor Descriptor of the subject (user, group, scope, etc.) to check state of (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
    ...
    /**
     * Operation membershipStatesGetAsync
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    public function membershipStatesGetAsync($organization, $subjectDescriptor, $apiVersion)
    {
        return $this->membershipStatesGetAsyncWithHttpInfo($organization, $subjectDescriptor, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation membershipStatesGetAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
    ...
    /**
     * Create request for operation 'membershipStatesGet'
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $subjectDescriptor Descriptor of the subject (user, group, scope, etc.) to check state of (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     ...
     */
    protected function membershipStatesGetRequest($organization, $subjectDescriptor, $apiVersion)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling membershipStatesGet'
            );
        }
        ...
        if ($subjectDescriptor === null || (is_array($subjectDescriptor) && count($subjectDescriptor) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $subjectDescriptor when calling membershipStatesGet'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling membershipStatesGet'
            );
        }

        $resourcePath = '/{organization}/_apis/graph/membershipstates/{subjectDescriptor}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
