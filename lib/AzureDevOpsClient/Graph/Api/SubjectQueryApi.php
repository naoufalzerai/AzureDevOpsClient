...
class SubjectQueryApi
{
    ...
    {
        list($response) = $this->subjectQueryQueryWithHttpInfo($organization, $body, $apiVersion);
        return $response;
    }
     ...
     */
    public function subjectQueryQueryAsync($organization, $body, $apiVersion)
    {
        return $this->subjectQueryQueryAsyncWithHttpInfo($organization, $body, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function subjectQueryQueryRequest($organization, $body, $apiVersion)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling subjectQueryQuery'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling subjectQueryQuery'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling subjectQueryQuery'
            );
        }

        $resourcePath = '/{organization}/_apis/graph/subjectquery';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
