...
/**
 * TokenListGlobalIdentitiesApi Class Doc Comment
 *
 * @category Class
 * @package  FrankHouweling\AzureDevOpsClient\TokenAdministration
 * @author   Swagger Codegen team
...
class TokenListGlobalIdentitiesApi
{
    ...
    /**
     * Operation tokenListGlobalIdentitiesList
     *
     ...
     * @return void
     */
    public function tokenListGlobalIdentitiesList($body, $apiVersion, $isPublic = null)
    {
        $this->tokenListGlobalIdentitiesListWithHttpInfo($body, $apiVersion, $isPublic);
    }

    /**
     * Operation tokenListGlobalIdentitiesListWithHttpInfo
     *
     * @param  \FrankHouweling\AzureDevOpsClient\TokenAdministration\Model\TokenAdminRevocation[] $body The list of identities containing the authorization IDs of the OAuth authorizations, such as session tokens retrieved by listed a users PATs, that should be checked for global access tokens. (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     * @param  bool $isPublic Set to false for PAT tokens and true for SSH tokens. (optional)
     ...
     */
    public function tokenListGlobalIdentitiesListWithHttpInfo($body, $apiVersion, $isPublic = null)
    {
        $returnType = '';
        $request = $this->tokenListGlobalIdentitiesListRequest($body, $apiVersion, $isPublic);
     ...
     */
    public function tokenListGlobalIdentitiesListAsync($body, $apiVersion, $isPublic = null)
    {
        return $this->tokenListGlobalIdentitiesListAsyncWithHttpInfo($body, $apiVersion, $isPublic)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tokenListGlobalIdentitiesListAsyncWithHttpInfo($body, $apiVersion, $isPublic = null)
    {
        $returnType = '';
        $request = $this->tokenListGlobalIdentitiesListRequest($body, $apiVersion, $isPublic);
    ...
    /**
     * Create request for operation 'tokenListGlobalIdentitiesList'
     *
     * @param  \FrankHouweling\AzureDevOpsClient\TokenAdministration\Model\TokenAdminRevocation[] $body The list of identities containing the authorization IDs of the OAuth authorizations, such as session tokens retrieved by listed a users PATs, that should be checked for global access tokens. (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     * @param  bool $isPublic Set to false for PAT tokens and true for SSH tokens. (optional)
     ...
     */
    protected function tokenListGlobalIdentitiesListRequest($body, $apiVersion, $isPublic = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling tokenListGlobalIdentitiesList'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling tokenListGlobalIdentitiesList'
            );
        }

        $resourcePath = '/_apis/tokenadministration/tokenlistglobalidentities';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
