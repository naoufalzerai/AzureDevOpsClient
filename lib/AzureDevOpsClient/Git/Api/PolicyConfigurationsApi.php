...
class PolicyConfigurationsApi
{
    ...
    /**
     * Operation policyConfigurationsGet
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     * @param  string $repositoryId The repository id. (optional)
     * @param  string $refName The fully-qualified Git ref name (e.g. refs/heads/master). (optional)
     * @param  string $policyType The policy type filter. (optional)
    ...
    {
        list($response) = $this->policyConfigurationsGetWithHttpInfo($organization, $project, $apiVersion, $repositoryId, $refName, $policyType, $top, $continuationToken);
        return $response;
    }

    /**
     * Operation policyConfigurationsGetWithHttpInfo
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
    ...
    /**
     * Operation policyConfigurationsGetAsync
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    public function policyConfigurationsGetAsync($organization, $project, $apiVersion, $repositoryId = null, $refName = null, $policyType = null, $top = null, $continuationToken = null)
    {
        return $this->policyConfigurationsGetAsyncWithHttpInfo($organization, $project, $apiVersion, $repositoryId, $refName, $policyType, $top, $continuationToken)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation policyConfigurationsGetAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
    ...
    /**
     * Create request for operation 'policyConfigurationsGet'
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     ...
     */
    protected function policyConfigurationsGetRequest($organization, $project, $apiVersion, $repositoryId = null, $refName = null, $policyType = null, $top = null, $continuationToken = null)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling policyConfigurationsGet'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling policyConfigurationsGet'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling policyConfigurationsGet'
            );
        }

        $resourcePath = '/{organization}/{project}/_apis/git/policy/configurations';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
