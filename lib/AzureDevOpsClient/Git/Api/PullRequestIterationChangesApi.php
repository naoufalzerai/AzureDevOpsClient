...
class PullRequestIterationChangesApi
{
    ...
    /**
     * Operation pullRequestIterationChangesGet
     *
     ...
     * @param  int $iterationId ID of the pull request iteration. &lt;br /&gt; Iteration IDs are zero-based with zero indicating the common commit between the source and target branches. Iteration one is the head of the source branch at the time the pull request is created and subsequent iterations are created when there are pushes to the source branch. (required)
     * @param  string $project Project ID or project name (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     * @param  int $top Optional. The number of changes to retrieve.  The default value is 100 and the maximum value is 2000. (optional)
    ...
    {
        list($response) = $this->pullRequestIterationChangesGetWithHttpInfo($organization, $repositoryId, $pullRequestId, $iterationId, $project, $apiVersion, $top, $skip, $compareTo);
        return $response;
    }

    /**
     * Operation pullRequestIterationChangesGetWithHttpInfo
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $repositoryId The repository ID of the pull request&#39;s target branch. (required)
     * @param  int $pullRequestId ID of the pull request. (required)
    ...
    /**
     * Operation pullRequestIterationChangesGetAsync
     *
     * 
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    public function pullRequestIterationChangesGetAsync($organization, $repositoryId, $pullRequestId, $iterationId, $project, $apiVersion, $top = null, $skip = null, $compareTo = null)
    {
        return $this->pullRequestIterationChangesGetAsyncWithHttpInfo($organization, $repositoryId, $pullRequestId, $iterationId, $project, $apiVersion, $top, $skip, $compareTo)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation pullRequestIterationChangesGetAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
    ...
    /**
     * Create request for operation 'pullRequestIterationChangesGet'
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $repositoryId The repository ID of the pull request&#39;s target branch. (required)
     * @param  int $pullRequestId ID of the pull request. (required)
     ...
     */
    protected function pullRequestIterationChangesGetRequest($organization, $repositoryId, $pullRequestId, $iterationId, $project, $apiVersion, $top = null, $skip = null, $compareTo = null)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling pullRequestIterationChangesGet'
            );
        }
        // verify the required parameter 'repositoryId' is set
        if ($repositoryId === null || (is_array($repositoryId) && count($repositoryId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $repositoryId when calling pullRequestIterationChangesGet'
            );
        }
        // verify the required parameter 'pullRequestId' is set
        if ($pullRequestId === null || (is_array($pullRequestId) && count($pullRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pullRequestId when calling pullRequestIterationChangesGet'
            );
        }
        // verify the required parameter 'iterationId' is set
        if ($iterationId === null || (is_array($iterationId) && count($iterationId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $iterationId when calling pullRequestIterationChangesGet'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling pullRequestIterationChangesGet'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling pullRequestIterationChangesGet'
            );
        }

        $resourcePath = '/{organization}/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/iterations/{iterationId}/changes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($compareTo !== null) {
            $queryParams['$compareTo'] = ObjectSerializer::toQueryValue($compareTo);
        }
        // query params
        if ($apiVersion !== null) {
