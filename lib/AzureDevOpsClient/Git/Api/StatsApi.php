...
class StatsApi
{
     ...
     * @param  string $baseVersionDescriptorVersion Version string identifier (name of tag/branch, SHA1 of commit) (optional)
    ...
    {
        list($response) = $this->statsListWithHttpInfo($organization, $repositoryId, $project, $apiVersion, $baseVersionDescriptorVersion, $baseVersionDescriptorVersionOptions, $baseVersionDescriptorVersionType);
        return $response;
    }

    /**
     * Operation statsListWithHttpInfo
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $repositoryId The name or ID of the repository. (required)
     * @param  string $project Project ID or project name (required)
     ...
     */
    public function statsListAsync($organization, $repositoryId, $project, $apiVersion, $baseVersionDescriptorVersion = null, $baseVersionDescriptorVersionOptions = null, $baseVersionDescriptorVersionType = null)
    {
        return $this->statsListAsyncWithHttpInfo($organization, $repositoryId, $project, $apiVersion, $baseVersionDescriptorVersion, $baseVersionDescriptorVersionOptions, $baseVersionDescriptorVersionType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation statsListAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
    ...
    /**
     * Create request for operation 'statsList'
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $repositoryId The name or ID of the repository. (required)
     * @param  string $project Project ID or project name (required)
     ...
     */
    protected function statsListRequest($organization, $repositoryId, $project, $apiVersion, $baseVersionDescriptorVersion = null, $baseVersionDescriptorVersionOptions = null, $baseVersionDescriptorVersionType = null)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling statsList'
            );
        }
        // verify the required parameter 'repositoryId' is set
        if ($repositoryId === null || (is_array($repositoryId) && count($repositoryId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $repositoryId when calling statsList'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling statsList'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling statsList'
            );
        }

        $resourcePath = '/{organization}/{project}/_apis/git/repositories/{repositoryId}/stats/branches';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($baseVersionDescriptorVersion !== null) {
            $queryParams['baseVersionDescriptor.version'] = ObjectSerializer::toQueryValue($baseVersionDescriptorVersion);
        }
        // query params
        if ($baseVersionDescriptorVersionOptions !== null) {
            $queryParams['baseVersionDescriptor.versionOptions'] = ObjectSerializer::toQueryValue($baseVersionDescriptorVersionOptions);
        }
        // query params
        if ($baseVersionDescriptorVersionType !== null) {
            $queryParams['baseVersionDescriptor.versionType'] = ObjectSerializer::toQueryValue($baseVersionDescriptorVersionType);
        }
        // query params
        if ($apiVersion !== null) {
