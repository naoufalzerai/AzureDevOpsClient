...
class TreesApi
{
     ...
     * @param  string $repositoryId Repository Id. (required)
     * @param  string $sha1 SHA1 hash of the tree object. (required)
     * @param  string $project Project ID or project name (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     * @param  string $projectId Project Id. (optional)
     * @param  bool $recursive Search recursively. Include trees underneath this tree. Default is false. (optional)
    ...
    {
        list($response) = $this->treesGetWithHttpInfo($organization, $repositoryId, $sha1, $project, $apiVersion, $projectId, $recursive, $fileName, $format);
        return $response;
    }

    /**
     * Operation treesGetWithHttpInfo
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $repositoryId Repository Id. (required)
     * @param  string $sha1 SHA1 hash of the tree object. (required)
     ...
     */
    public function treesGetAsync($organization, $repositoryId, $sha1, $project, $apiVersion, $projectId = null, $recursive = null, $fileName = null, $format = null)
    {
        return $this->treesGetAsyncWithHttpInfo($organization, $repositoryId, $sha1, $project, $apiVersion, $projectId, $recursive, $fileName, $format)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation treesGetAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
    ...
    /**
     * Create request for operation 'treesGet'
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $repositoryId Repository Id. (required)
     * @param  string $sha1 SHA1 hash of the tree object. (required)
     ...
     */
    protected function treesGetRequest($organization, $repositoryId, $sha1, $project, $apiVersion, $projectId = null, $recursive = null, $fileName = null, $format = null)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling treesGet'
            );
        }
        // verify the required parameter 'repositoryId' is set
        if ($repositoryId === null || (is_array($repositoryId) && count($repositoryId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $repositoryId when calling treesGet'
            );
        }
        // verify the required parameter 'sha1' is set
        if ($sha1 === null || (is_array($sha1) && count($sha1) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sha1 when calling treesGet'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling treesGet'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling treesGet'
            );
        }

        $resourcePath = '/{organization}/{project}/_apis/git/repositories/{repositoryId}/trees/{sha1}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
