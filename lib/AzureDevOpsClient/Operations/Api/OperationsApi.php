...
namespace FrankHouweling\AzureDevOpsClient\Operations\Api;
...
class OperationsApi
{
     ...
     *
     * @param  string $operationId The ID for the operation. (required)
    ...
    {
        list($response) = $this->operationsGetWithHttpInfo($operationId, $organization, $apiVersion, $pluginId);
        return $response;
    }
     ...
     */
    public function operationsGetAsync($operationId, $organization, $apiVersion, $pluginId = null)
    {
        return $this->operationsGetAsyncWithHttpInfo($operationId, $organization, $apiVersion, $pluginId)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function operationsGetRequest($operationId, $organization, $apiVersion, $pluginId = null)
    {
        // verify the required parameter 'operationId' is set
        if ($operationId === null || (is_array($operationId) && count($operationId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $operationId when calling operationsGet'
            );
        }
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling operationsGet'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling operationsGet'
            );
        }

        $resourcePath = '/{organization}/_apis/operations/{operationId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($pluginId !== null) {
            $queryParams['pluginId'] = ObjectSerializer::toQueryValue($pluginId);
        }
        // query params
        if ($apiVersion !== null) {
