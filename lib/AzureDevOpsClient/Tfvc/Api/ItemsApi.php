...
class ItemsApi
{
     ...
     * @return null[][]
     */
    public function itemsGetItemsBatch($organization, $body, $project, $apiVersion)
    {
        list($response) = $this->itemsGetItemsBatchWithHttpInfo($organization, $body, $project, $apiVersion);
        return $response;
    }
     ...
     */
    public function itemsGetItemsBatchWithHttpInfo($organization, $body, $project, $apiVersion)
    {
        $returnType = 'null[][]';
        $request = $this->itemsGetItemsBatchRequest($organization, $body, $project, $apiVersion);
     ...
     */
    public function itemsGetItemsBatchAsync($organization, $body, $project, $apiVersion)
    {
        return $this->itemsGetItemsBatchAsyncWithHttpInfo($organization, $body, $project, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function itemsGetItemsBatchAsyncWithHttpInfo($organization, $body, $project, $apiVersion)
    {
        $returnType = 'null[][]';
        $request = $this->itemsGetItemsBatchRequest($organization, $body, $project, $apiVersion);
     ...
     */
    protected function itemsGetItemsBatchRequest($organization, $body, $project, $apiVersion)
    {
        ...
        $resourcePath = '/{organization}/{project}/_apis/tfvc/itembatch';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $project Project ID or project name (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     * @param  string $scopePath Version control path of a folder to return multiple items. (optional)
     * @param  string $recursionLevel None (just the item), or OneLevel (contents of a folder). (optional)
     * @param  bool $includeLinks True to include links. (optional)
     * @param  string $versionDescriptorVersion Version object. (optional)
    ...
    {
        list($response) = $this->itemsListWithHttpInfo($organization, $project, $apiVersion, $scopePath, $recursionLevel, $includeLinks, $versionDescriptorVersion, $versionDescriptorVersionOption, $versionDescriptorVersionType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function itemsListAsync($organization, $project, $apiVersion, $scopePath = null, $recursionLevel = null, $includeLinks = null, $versionDescriptorVersion = null, $versionDescriptorVersionOption = null, $versionDescriptorVersionType = null)
    {
        return $this->itemsListAsyncWithHttpInfo($organization, $project, $apiVersion, $scopePath, $recursionLevel, $includeLinks, $versionDescriptorVersion, $versionDescriptorVersionOption, $versionDescriptorVersionType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function itemsListRequest($organization, $project, $apiVersion, $scopePath = null, $recursionLevel = null, $includeLinks = null, $versionDescriptorVersion = null, $versionDescriptorVersionOption = null, $versionDescriptorVersionType = null)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/{organization}/{project}/_apis/tfvc/items';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($versionDescriptorVersionOption !== null) {
            $queryParams['versionDescriptor.versionOption'] = ObjectSerializer::toQueryValue($versionDescriptorVersionOption);
        }
        // query params
