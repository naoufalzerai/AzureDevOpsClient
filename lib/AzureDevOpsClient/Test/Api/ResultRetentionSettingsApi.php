...
class ResultRetentionSettingsApi
{
    ...
    /**
     * Operation resultRetentionSettingsGet
     *
    ...
    {
        list($response) = $this->resultRetentionSettingsGetWithHttpInfo($organization, $project, $apiVersion);
        return $response;
    }

    /**
     * Operation resultRetentionSettingsGetWithHttpInfo
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
    ...
    /**
     * Operation resultRetentionSettingsGetAsync
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    public function resultRetentionSettingsGetAsync($organization, $project, $apiVersion)
    {
        return $this->resultRetentionSettingsGetAsyncWithHttpInfo($organization, $project, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation resultRetentionSettingsGetAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
    ...
    /**
     * Create request for operation 'resultRetentionSettingsGet'
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     ...
     */
    protected function resultRetentionSettingsGetRequest($organization, $project, $apiVersion)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling resultRetentionSettingsGet'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling resultRetentionSettingsGet'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling resultRetentionSettingsGet'
            );
        }

        $resourcePath = '/{organization}/{project}/_apis/test/resultretentionsettings';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->resultRetentionSettingsUpdateWithHttpInfo($organization, $body, $project, $apiVersion);
        return $response;
    }
    ...
    /**
     * Operation resultRetentionSettingsUpdateAsync
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resultRetentionSettingsUpdateAsync($organization, $body, $project, $apiVersion)
    {
        return $this->resultRetentionSettingsUpdateAsyncWithHttpInfo($organization, $body, $project, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation resultRetentionSettingsUpdateAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function resultRetentionSettingsUpdateRequest($organization, $body, $project, $apiVersion)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling resultRetentionSettingsUpdate'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling resultRetentionSettingsUpdate'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling resultRetentionSettingsUpdate'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling resultRetentionSettingsUpdate'
            );
        }
