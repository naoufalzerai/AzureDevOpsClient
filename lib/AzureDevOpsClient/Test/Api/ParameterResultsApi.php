...
class ParameterResultsApi
{
    ...
    /**
     * Operation parameterResultsList
     *
     ...
     * @param  int $iterationId ID of the iteration that contains the parameterized results. (required)
    ...
    {
        list($response) = $this->parameterResultsListWithHttpInfo($organization, $project, $runId, $testCaseResultId, $iterationId, $apiVersion, $paramName);
        return $response;
    }

    /**
     * Operation parameterResultsListWithHttpInfo
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  int $runId ID of the test run that contains the result. (required)
    ...
    /**
     * Operation parameterResultsListAsync
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    public function parameterResultsListAsync($organization, $project, $runId, $testCaseResultId, $iterationId, $apiVersion, $paramName = null)
    {
        return $this->parameterResultsListAsyncWithHttpInfo($organization, $project, $runId, $testCaseResultId, $iterationId, $apiVersion, $paramName)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation parameterResultsListAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
    ...
    /**
     * Create request for operation 'parameterResultsList'
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  int $runId ID of the test run that contains the result. (required)
     ...
     */
    protected function parameterResultsListRequest($organization, $project, $runId, $testCaseResultId, $iterationId, $apiVersion, $paramName = null)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling parameterResultsList'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling parameterResultsList'
            );
        }
        // verify the required parameter 'runId' is set
        if ($runId === null || (is_array($runId) && count($runId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $runId when calling parameterResultsList'
            );
        }
        ...
        if ($testCaseResultId === null || (is_array($testCaseResultId) && count($testCaseResultId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $testCaseResultId when calling parameterResultsList'
            );
        }
        // verify the required parameter 'iterationId' is set
        if ($iterationId === null || (is_array($iterationId) && count($iterationId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $iterationId when calling parameterResultsList'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling parameterResultsList'
            );
        }

        $resourcePath = '/{organization}/{project}/_apis/test/Runs/{runId}/Results/{testCaseResultId}/Iterations/{iterationId}/parameterresults';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($paramName !== null) {
            $queryParams['paramName'] = ObjectSerializer::toQueryValue($paramName);
        }
        // query params
        if ($apiVersion !== null) {
