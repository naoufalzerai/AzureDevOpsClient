...
class ProcessesApi
{
    ...
    {
        list($response) = $this->processesGetWithHttpInfo($organization, $processId, $apiVersion);
        return $response;
    }
     ...
     */
    public function processesGetAsync($organization, $processId, $apiVersion)
    {
        return $this->processesGetAsyncWithHttpInfo($organization, $processId, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function processesGetRequest($organization, $processId, $apiVersion)
    {
        ...
        if ($processId === null || (is_array($processId) && count($processId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $processId when calling processesGet'
            );
        }
        ...
        $resourcePath = '/{organization}/_apis/process/processes/{processId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->processesListWithHttpInfo($organization, $apiVersion);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function processesListAsync($organization, $apiVersion)
    {
        return $this->processesListAsyncWithHttpInfo($organization, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function processesListRequest($organization, $apiVersion)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/{organization}/_apis/process/processes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
