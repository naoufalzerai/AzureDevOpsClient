...
class WorkitemsorderApi
{
    ...
    {
        list($response) = $this->workitemsorderReorderBacklogWorkItemsWithHttpInfo($organization, $body, $project, $team, $apiVersion);
        return $response;
    }
    ...
    /**
     * Operation workitemsorderReorderBacklogWorkItemsAsync
     *
     * 
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    public function workitemsorderReorderBacklogWorkItemsAsync($organization, $body, $project, $team, $apiVersion)
    {
        return $this->workitemsorderReorderBacklogWorkItemsAsyncWithHttpInfo($organization, $body, $project, $team, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation workitemsorderReorderBacklogWorkItemsAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    protected function workitemsorderReorderBacklogWorkItemsRequest($organization, $body, $project, $team, $apiVersion)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling workitemsorderReorderBacklogWorkItems'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling workitemsorderReorderBacklogWorkItems'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling workitemsorderReorderBacklogWorkItems'
            );
        }
        // verify the required parameter 'team' is set
        if ($team === null || (is_array($team) && count($team) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $team when calling workitemsorderReorderBacklogWorkItems'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling workitemsorderReorderBacklogWorkItems'
            );
        }

        $resourcePath = '/{organization}/{project}/{team}/_apis/work/workitemsorder';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->workitemsorderReorderIterationWorkItemsWithHttpInfo($organization, $body, $project, $team, $iterationId, $apiVersion);
        return $response;
    }
    ...
    /**
     * Operation workitemsorderReorderIterationWorkItemsAsync
     *
     * 
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function workitemsorderReorderIterationWorkItemsAsync($organization, $body, $project, $team, $iterationId, $apiVersion)
    {
        return $this->workitemsorderReorderIterationWorkItemsAsyncWithHttpInfo($organization, $body, $project, $team, $iterationId, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation workitemsorderReorderIterationWorkItemsAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function workitemsorderReorderIterationWorkItemsRequest($organization, $body, $project, $team, $iterationId, $apiVersion)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling workitemsorderReorderIterationWorkItems'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling workitemsorderReorderIterationWorkItems'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling workitemsorderReorderIterationWorkItems'
            );
        }
        // verify the required parameter 'team' is set
        if ($team === null || (is_array($team) && count($team) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $team when calling workitemsorderReorderIterationWorkItems'
            );
        }
        // verify the required parameter 'iterationId' is set
        if ($iterationId === null || (is_array($iterationId) && count($iterationId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $iterationId when calling workitemsorderReorderIterationWorkItems'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling workitemsorderReorderIterationWorkItems'
            );
        }

        $resourcePath = '/{organization}/{project}/{team}/_apis/work/iterations/{iterationId}/workitemsorder';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
