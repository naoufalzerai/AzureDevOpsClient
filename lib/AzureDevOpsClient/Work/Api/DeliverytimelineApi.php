...
class DeliverytimelineApi
{
    ...
    /**
     * Operation deliverytimelineGet
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  string $id Identifier for delivery view (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     * @param  int $revision Revision of the plan for which you want data. If the current plan is a different revision you will get an ViewRevisionMismatchException exception. If you do not supply a revision you will get data for the latest revision. (optional)
    ...
    {
        list($response) = $this->deliverytimelineGetWithHttpInfo($organization, $project, $id, $apiVersion, $revision, $startDate, $endDate);
        return $response;
    }

    /**
     * Operation deliverytimelineGetWithHttpInfo
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  string $id Identifier for delivery view (required)
    ...
    /**
     * Operation deliverytimelineGetAsync
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    public function deliverytimelineGetAsync($organization, $project, $id, $apiVersion, $revision = null, $startDate = null, $endDate = null)
    {
        return $this->deliverytimelineGetAsyncWithHttpInfo($organization, $project, $id, $apiVersion, $revision, $startDate, $endDate)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deliverytimelineGetAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
    ...
    /**
     * Create request for operation 'deliverytimelineGet'
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  string $id Identifier for delivery view (required)
     ...
     */
    protected function deliverytimelineGetRequest($organization, $project, $id, $apiVersion, $revision = null, $startDate = null, $endDate = null)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling deliverytimelineGet'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling deliverytimelineGet'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deliverytimelineGet'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling deliverytimelineGet'
            );
        }

        $resourcePath = '/{organization}/{project}/_apis/work/plans/{id}/deliverytimeline';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
