...
class RowsApi
{
    ...
    {
        list($response) = $this->rowsListWithHttpInfo($organization, $project, $board, $team, $apiVersion);
        return $response;
    }

    /**
     * Operation rowsListWithHttpInfo
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  string $board Name or ID of the specific board (required)
     ...
     */
    public function rowsListAsync($organization, $project, $board, $team, $apiVersion)
    {
        return $this->rowsListAsyncWithHttpInfo($organization, $project, $board, $team, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation rowsListAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
    ...
    /**
     * Create request for operation 'rowsList'
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  string $board Name or ID of the specific board (required)
     ...
     */
    protected function rowsListRequest($organization, $project, $board, $team, $apiVersion)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling rowsList'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling rowsList'
            );
        }
        // verify the required parameter 'board' is set
        if ($board === null || (is_array($board) && count($board) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $board when calling rowsList'
            );
        }
        // verify the required parameter 'team' is set
        if ($team === null || (is_array($team) && count($team) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $team when calling rowsList'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling rowsList'
            );
        }

        $resourcePath = '/{organization}/{project}/{team}/_apis/work/boards/{board}/rows';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->rowsUpdateWithHttpInfo($organization, $body, $project, $board, $team, $apiVersion);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rowsUpdateAsync($organization, $body, $project, $board, $team, $apiVersion)
    {
        return $this->rowsUpdateAsyncWithHttpInfo($organization, $body, $project, $board, $team, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation rowsUpdateAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function rowsUpdateRequest($organization, $body, $project, $board, $team, $apiVersion)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling rowsUpdate'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling rowsUpdate'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling rowsUpdate'
            );
        }
        // verify the required parameter 'board' is set
        if ($board === null || (is_array($board) && count($board) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $board when calling rowsUpdate'
            );
        }
        // verify the required parameter 'team' is set
        if ($team === null || (is_array($team) && count($team) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $team when calling rowsUpdate'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling rowsUpdate'
            );
        }
