...
namespace FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\Api;
...
use FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\ApiException;
use FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\Configuration;
use FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\HeaderSelector;
...
class NpmApi
{
     ...
     *
     * @throws \FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\ApiException on non-2xx response
     ...
     * @throws \FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\Model\Package
     */
     ...
     * @throws \FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\Model\Package, HTTP status code, HTTP response headers (array of strings)
     */
    public function npmGetPackageVersionWithHttpInfo($organization, $feedId, $packageName, $packageVersion, $project, $apiVersion)
    {
        $returnType = '\FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\Model\Package';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\Model\Package',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\Model\NpmPackageVersionDeletionState
     */
     ...
     * @throws \FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\Model\NpmPackageVersionDeletionState, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\Model\NpmPackageVersionDeletionState';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\Model\NpmPackageVersionDeletionState',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  \FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\Model\NpmRecycleBinPackageVersionDetails $body  (required)
     * @param  string $feedId Name or ID of the feed. (required)
     * @param  string $packageName Name of the package. (required)
     * @param  string $packageVersion Version of the package. (required)
     * @param  string $project Project ID or project name (required)
     ...
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  \FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\Model\PackageVersionDetails $body  (required)
     * @param  string $feedId  (required)
     ...
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  \FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\Model\NpmPackagesBatchRequest $body Information about the packages to update, the operation to perform, and its associated data. (required)
     * @param  string $feedId Name or ID of the feed. (required)
     * @param  string $project Project ID or project name (required)
     * @param  string $apiVersion Version of the API to use.  This should be set to &#39;6.0-preview.1&#39; to use this version of the api. (required)
     *
