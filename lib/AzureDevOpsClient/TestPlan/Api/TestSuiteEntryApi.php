...
class TestSuiteEntryApi
{
    ...
    {
        list($response) = $this->testSuiteEntryListWithHttpInfo($organization, $project, $suiteId, $apiVersion, $suiteEntryType);
        return $response;
    }

    /**
     * Operation testSuiteEntryListWithHttpInfo
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  int $suiteId Id of the parent suite. (required)
    ...
    /**
     * Operation testSuiteEntryListAsync
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     */
    public function testSuiteEntryListAsync($organization, $project, $suiteId, $apiVersion, $suiteEntryType = null)
    {
        return $this->testSuiteEntryListAsyncWithHttpInfo($organization, $project, $suiteId, $apiVersion, $suiteEntryType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation testSuiteEntryListAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
    ...
    /**
     * Create request for operation 'testSuiteEntryList'
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     * @param  string $project Project ID or project name (required)
     * @param  int $suiteId Id of the parent suite. (required)
     ...
     */
    protected function testSuiteEntryListRequest($organization, $project, $suiteId, $apiVersion, $suiteEntryType = null)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling testSuiteEntryList'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling testSuiteEntryList'
            );
        }
        // verify the required parameter 'suiteId' is set
        if ($suiteId === null || (is_array($suiteId) && count($suiteId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $suiteId when calling testSuiteEntryList'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling testSuiteEntryList'
            );
        }

        $resourcePath = '/{organization}/{project}/_apis/testplan/suiteentry/{suiteId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($suiteEntryType !== null) {
            $queryParams['suiteEntryType'] = ObjectSerializer::toQueryValue($suiteEntryType);
        }
        // query params
        if ($apiVersion !== null) {
    ...
    {
        list($response) = $this->testSuiteEntryReorderSuiteEntriesWithHttpInfo($organization, $body, $project, $suiteId, $apiVersion);
        return $response;
    }
    ...
    /**
     * Operation testSuiteEntryReorderSuiteEntriesAsync
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testSuiteEntryReorderSuiteEntriesAsync($organization, $body, $project, $suiteId, $apiVersion)
    {
        return $this->testSuiteEntryReorderSuiteEntriesAsyncWithHttpInfo($organization, $body, $project, $suiteId, $apiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation testSuiteEntryReorderSuiteEntriesAsyncWithHttpInfo
     *
     *
     *
     * @param  string $organization The name of the Azure DevOps organization. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function testSuiteEntryReorderSuiteEntriesRequest($organization, $body, $project, $suiteId, $apiVersion)
    {
        // verify the required parameter 'organization' is set
        if ($organization === null || (is_array($organization) && count($organization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization when calling testSuiteEntryReorderSuiteEntries'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling testSuiteEntryReorderSuiteEntries'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling testSuiteEntryReorderSuiteEntries'
            );
        }
        // verify the required parameter 'suiteId' is set
        if ($suiteId === null || (is_array($suiteId) && count($suiteId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $suiteId when calling testSuiteEntryReorderSuiteEntries'
            );
        }
        // verify the required parameter 'apiVersion' is set
        if ($apiVersion === null || (is_array($apiVersion) && count($apiVersion) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiVersion when calling testSuiteEntryReorderSuiteEntries'
            );
        }
